...
public class ParametersHelper {
    ...
    public static final String KEY_CAMERA_MANUAL_SHUTTER = "shutter-value";
    ...
    //XCSW2 GuoYanjie add for ProfessionalManager start
    private static final String KEY_CAMERA_FOCUS_MODE = "focus-mode";
    private static final String KEY_CAMERA_MANUAL_FOCUS = "afeng-pos";
    //XCSW2 GuoYanjie add for ProfessionalManager end
    public static void setParametersValue(Parameters parameters, int cameraId, String key,
        ...
        case SettingConstants.ROW_SETTING_CAMERA_MANUAL_FOCUS:
            if(value.equals("auto")){
                parameters.set(ParametersHelper.KEY_CAMERA_FOCUS_MODE, "auto");
            }else{
                parameters.set(ParametersHelper.KEY_CAMERA_FOCUS_MODE, "manual");
                parameters.set(ParametersHelper.KEY_CAMERA_MANUAL_FOCUS, value);
            }
            break;
        case SettingConstants.ROW_SETTING_CAMERA_MANUAL_SHUTTER:
            parameters.set(ParametersHelper.KEY_CAMERA_MANUAL_SHUTTER, value);
            break;
        //XCSW2 GuoYanjie add for ProfessionalManager end
    ...
    public static String getParametersValue(Parameters parameters, String key) {
        ...
        //XCSW2 GuoYanjie add for ProfessionalManager start
        case SettingConstants.ROW_SETTING_CAMERA_MANUAL_FOCUS:
            value = parameters.get(KEY_CAMERA_FOCUS_MODE);
            if(value.equals("manual")){
                value = parameters.get(KEY_CAMERA_MANUAL_FOCUS);
            }
            Log.e(TAG, "getParametersValue ManualFocus Value = " + value);
            break;
        case SettingConstants.ROW_SETTING_CAMERA_MANUAL_SHUTTER:
            value = parameters.get(KEY_CAMERA_MANUAL_SHUTTER);
            break;
        //XCSW2 GuoYanjie add for ProfessionalManager end
        case SettingConstants.ROW_SETTING_MULTI_FACE_MODE:
    ...
    public static List<String> getParametersSupportedValues(Parameters parameters, String key) {
        ...
        //XCSW2 GuoYanjie add for ProfessionalManager start
        case SettingConstants.ROW_SETTING_CAMERA_MANUAL_FOCUS:
            //supportedList = getSupportedValues(parameters, KEY_CAMERA_FOCUS_MODE);
            break;
        case SettingConstants.ROW_SETTING_CAMERA_MANUAL_SHUTTER:
            supportedList = getSupportedValues(parameters, KEY_CAMERA_MANUAL_SHUTTER);
            break;
        //XCSW2 GuoYanjie add for ProfessionalManager end
        default:

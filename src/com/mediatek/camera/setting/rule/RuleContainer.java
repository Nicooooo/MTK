        ...
        public void execute() {
            ...
            if (null == nr3dSupportedQuality ||
                ...
                if (Integer.parseInt(qualityValue) > supportQuality) {
                    ...
                    String value = "off";
                    applyOverride(SettingConstants.KEY_VIDEO_QUALITY,
                            SettingConstants.KEY_VIDEO_3DNR, overrideValue, value,
                            parameters, cameraId);
                } else {
                    cancelOverride(SettingConstants.KEY_VIDEO_QUALITY,
                            SettingConstants.KEY_VIDEO_3DNR, parameters, cameraId);
                }
            }
        }

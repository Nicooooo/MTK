...
public class SettingDataBase {
    ...
    static {
        ...
        //wangleiquan for KYJSEFLY-142 (start)
        if (com.xchengtech.ProjectConfig.FEATURE_DUAL_CAMERA_SWITCH_IN_HDR) {
            MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_DUAL_CAMERA]           = new int[]{
                    STATE_E0, STATE_E0, STATE_E0, STATE_D0, STATE_D0, STATE_E0,
        ...
        //wangleiquan for KYJSEFLY-142 (end)
 ...
 MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_SLOW_MOTION_VIDEO_QUALITY]    = new int[]{
    ...
    static {
        ...
        RESET_STATE_VALUE[SettingConstants.ROW_SETTING_DNG]
                = new String[]{"off", "on"};
        //xcsw2 huanglijun 20161123 add shutter sound item begin
        //RESET_STATE_VALUE[SettingConstants.ROW_SETTING_CAMERA_SHUTTER_SOUND]
                //= new String[]{"off", "on"};
        //xcsw2 huanglijun 20161123 add shutter sound item end
        //XCSW2 GuoYanjie add for GridLines start
        //Add by guanxiubiao for KYQAZEN-273 add volume key function menu 20161010
        RESET_STATE_VALUE[SettingConstants.ROW_SETTING_VOLUME_RESPONSE]    = new String[]{"volume"};
        RESET_STATE_VALUE[SettingConstants.ROW_SETTING_CAMERA_GRID_LINES]         = new String[]{"off", "on"};
        //XCSW2 GuoYanjie add for GridLines end
        //XCSW2 GuoYanjie add for ProfessionalManager start
        RESET_STATE_VALUE[SettingConstants.ROW_SETTING_CAMERA_MANUAL_FOCUS]         = new String[]{"auto"};//auto
        RESET_STATE_VALUE[SettingConstants.ROW_SETTING_CAMERA_MANUAL_SHUTTER]         = new String[]{"0"};
        //XCSW2 GuoYanjie add for ProfessionalManager end
        //Add by liyafeng 20170225 start
        RESET_STATE_VALUE[SettingConstants.ROW_SETTING_WHITE_LCD] = new String[]{"off", "on"};
        //Add by liyafeng 20170225 end
        //xcsw2 liyafeng 20170323 add timestamp item begin
        RESET_STATE_VALUE[SettingConstants.ROW_SETTING_TIMESTAMP] = new String[]{"off", "on"};
        //xcsw2 liyafeng 20170323 add timestamp item end
        //xcsw2 liyafeng 20170405 add storage location item begin
        RESET_STATE_VALUE[SettingConstants.ROW_SETTING_STORAGE_LOCATION] = new String[]{"internal", "external"};
    ...
    static {
        ...
        //xcsw2 huanglijun 20161123 add shutter sound item begin
        DEFAULT_VALUE_FOR_SETTING_ID[SettingConstants.ROW_SETTING_CAMERA_SHUTTER_SOUND]
                = R.string.pref_camera_shutter_sound_default;
        //xcsw2 huanglijun 20161123 add shutter sound item end
        //XCSW2 GuoYanjie add for GridLines start
        //Add by guanxiubiao for KYQAZEN-273 add volume key function menu 20161010
        DEFAULT_VALUE_FOR_SETTING_ID[SettingConstants.ROW_SETTING_VOLUME_RESPONSE]    = R.string.pref_camera_volume_response_default;
        DEFAULT_VALUE_FOR_SETTING_ID[SettingConstants.ROW_SETTING_CAMERA_GRID_LINES]              = R.string.pref_camera_grid_default;
        //XCSW2 GuoYanjie add for GridLines end
        //XCSW2 GuoYanjie add for ProfessionalManager start
        DEFAULT_VALUE_FOR_SETTING_ID[SettingConstants.ROW_SETTING_CAMERA_MANUAL_FOCUS]              = R.string.pref_camera_manualfocus_default;
        DEFAULT_VALUE_FOR_SETTING_ID[SettingConstants.ROW_SETTING_CAMERA_MANUAL_SHUTTER]              = R.string.pref_camera_manual_shutter_default;
        //XCSW2 GuoYanjie add for ProfessionalManager end
        //Add by liyafeng 20170225 start
        DEFAULT_VALUE_FOR_SETTING_ID[SettingConstants.ROW_SETTING_WHITE_LCD]         = R.string.pref_camera_white_lcd_default;
        //Add by liyafeng 20170225 end
        //xcsw2 liyafeng 20170323 add timestamp item begin
        DEFAULT_VALUE_FOR_SETTING_ID[SettingConstants.ROW_SETTING_TIMESTAMP]         = R.string.pref_camera_timestamp_default;
        //xcsw2 liyafeng 20170323 add timestamp item end
        //xcsw2 liyafeng 20170405 add storage location item begin
        DEFAULT_VALUE_FOR_SETTING_ID[SettingConstants.ROW_SETTING_STORAGE_LOCATION]  = R.string.pref_camera_storage_location_default;
        //xcsw2 liyafeng 20170405 add storage location item end
    }
    ...
    static {
        ...
        //xcsw2 huanglijun 20161123 add shutter sound item begin
        //DEFAULT_VALUE_FOR_SETTING[SettingConstants.ROW_SETTING_CAMERA_SHUTTER_SOUND]     = "off";
        //xcsw2 huanglijun 20161123 add shutter sound item end
        //XCSW2 GuoYanjie add for GridLines start
        DEFAULT_VALUE_FOR_SETTING[SettingConstants.ROW_SETTING_CAMERA_GRID_LINES]          = "off";
        //XCSW2 GuoYanjie add for GridLines end
        //XCSW2 GuoYanjie add for ProfessionalManager start
        DEFAULT_VALUE_FOR_SETTING[SettingConstants.ROW_SETTING_CAMERA_MANUAL_FOCUS]          = "auto";
        DEFAULT_VALUE_FOR_SETTING[SettingConstants.ROW_SETTING_CAMERA_MANUAL_SHUTTER]          = "0";
        //XCSW2 GuoYanjie add for ProfessionalManager end
        //Add by liyafeng 20170225 start
        DEFAULT_VALUE_FOR_SETTING[SettingConstants.ROW_SETTING_WHITE_LCD]          = "off";
        //Add by liyafeng 20170225 end
        //xcsw2 liyafeng 20170323 add timestamp item begin
        DEFAULT_VALUE_FOR_SETTING[SettingConstants.ROW_SETTING_TIMESTAMP]          = "off";
        //xcsw2 liyafeng 20170323 add timestamp item end
        //xcsw2 liyafeng 20170405 add storage location item begin
        DEFAULT_VALUE_FOR_SETTING[SettingConstants.ROW_SETTING_STORAGE_LOCATION]          = "internal";
        //xcsw2 liyafeng 20170405 add storage location item end
    }

...
public class SettingConstants {
    ...
    //xcsw2 huanglijun 20161123 add shutter sound item begin
    public static final String KEY_CAMERA_SHUTTER_SOUND        = "pref_shutter_sound_key";
    //xcsw2 huanglijun 20161123 add shutter sound item end
    //XCSW2 GuoYanjie add for GridLines start
    public static final String KEY_CAMERA_GRID_LINES        = "pref_camera_grid_key";
    //XCSW2 GuoYanjie add for GridLines end
    //XCSW2 GuoYanjie add for ProfessionalManager start
    public static final String KEY_CAMERA_MANUAL_FOCUS        = "pref_camera_manualfocus_key";
    public static final String KEY_CAMERA_MANUAL_SHUTTER        = "pref_manual_shutter_key";
    //XCSW2 GuoYanjie add for ProfessionalManager end
    //Add by liyafeng 20170225 start
    public static final String KEY_WHITE_LCD                 = "pref_white_lcd_key";
    //Add by liyafeng 20170225 end
    //xcsw2 liyafeng 20170323 add timestamp item begin
    public static final String KEY_CAMERA_TIMESTAMP        = "pref_camera_timestamp_key";
    //xcsw2 liyafeng 20170323 add timestamp item end
    //Add by guanxiubiao for KYQAZEN-273 add volume key function menu 20161010 start
    public static final String KEY_VOLUME_RESPONSE  = "pref_volume_response_key";
    //Add by guanxiubiao for KYQAZEN-273 add volume key function menu 20161010 end
    //xcsw2 liyafeng 20170405 add storage location item begin
    public static final String KEY_CAMERA_STORAGE_LOCATION        = "pref_camera_storage_location_key";
    //xcsw2 liyafeng 20170405 add storage location item end
    ...
    //xcsw2 huanglijun 20161123 add shutter sound item begin
    public static final int ROW_SETTING_CAMERA_SHUTTER_SOUND      = 60;
    //xcsw2 huanglijun 20161123 add shutter sound item end
    //XCSW2 GuoYanjie add for GridLines start
    public static final int ROW_SETTING_CAMERA_GRID_LINES         = 61;
    //XCSW2 GuoYanjie add for GridLines end
    //XCSW2 GuoYanjie add for ProfessionalManager start
    public static final int ROW_SETTING_CAMERA_MANUAL_FOCUS       = 62;
    public static final int ROW_SETTING_CAMERA_MANUAL_SHUTTER     = 63;
    //XCSW2 GuoYanjie add for ProfessionalManager end
    //Add by liyafeng 20170225 start
    public static final int ROW_SETTING_WHITE_LCD = 64;
    //Add by liyafeng 20170225 end
    //xcsw2 liyafeng 20170323 add timestamp item begin
    public static final int ROW_SETTING_TIMESTAMP = 65;
    //xcsw2 liyafeng 20170323 add timestamp item end
    //Add by guanxiubiao for KYQAZEN-273 add volume key function menu 20161010 start
    public static final int ROW_SETTING_VOLUME_RESPONSE = 66;
    //Add by guanxiubiao for KYQAZEN-273 add volume key function menu 20161010 end
    //xcsw2 liyafeng 20170405 add storage location item begin
    public static final int ROW_SETTING_STORAGE_LOCATION = 67;
    //xcsw2 liyafeng 20170405 add storage location item end
    public static final int SETTING_COUNT = 68;//Must be keep Increment following add item
    ...
    static {
        ...
        //xcsw2 huanglijun 20161123 add shutter sound item begin
        SETTING_TYPE[ROW_SETTING_CAMERA_SHUTTER_SOUND]        = ONLY_IN_PEFERENCE;
        //xcsw2 huanglijun 20161123 add shutter sound item end
        //XCSW2 GuoYanjie add for GridLines start
        //Add by guanxiubiao for KYQAZEN-273 add volume key function menu 20161010 start
        SETTING_TYPE[ROW_SETTING_VOLUME_RESPONSE]        = ONLY_IN_PEFERENCE;
        //Add by guanxiubiao for KYQAZEN-273 add volume key function menu 20161010 end
        SETTING_TYPE[ROW_SETTING_CAMERA_GRID_LINES]        = ONLY_IN_PEFERENCE;
        //XCSW2 GuoYanjie add for GridLines end
        //XCSW2 GuoYanjie add for ProfessionalManager start
        SETTING_TYPE[ROW_SETTING_CAMERA_MANUAL_FOCUS]        = BOTH_IN_PARAMETER_AND_PREFERENCE;
        SETTING_TYPE[ROW_SETTING_CAMERA_MANUAL_SHUTTER]        = BOTH_IN_PARAMETER_AND_PREFERENCE;
        //XCSW2 GuoYanjie add for ProfessionalManager end
        //Add by liyafeng 20170225 start
        SETTING_TYPE[ROW_SETTING_WHITE_LCD] = ONLY_IN_PEFERENCE;
        //Add by liyafeng 20170225 end
        //xcsw2 liyafeng 20170323 add timestamp item begin
        SETTING_TYPE[ROW_SETTING_TIMESTAMP] = ONLY_IN_PEFERENCE;
        //xcsw2 liyafeng 20170323 add timestamp item end
        //xcsw2 liyafeng 20170405 add storage location item begin
        SETTING_TYPE[ROW_SETTING_STORAGE_LOCATION] = ONLY_IN_PEFERENCE;
        //xcsw2 liyafeng 20170405 add storage location item end
    }
    ...
    static {
        ...
        //xcsw2 huanglijun 20161123 add shutter sound item begin
        KEYS_FOR_SETTING[ROW_SETTING_CAMERA_SHUTTER_SOUND]    = KEY_CAMERA_SHUTTER_SOUND;
        //xcsw2 huanglijun 20161123 add shutter sound item end
        //Add by guanxiubiao for KYQAZEN-273 add volume key function menu 20161010 start
        KEYS_FOR_SETTING[ROW_SETTING_VOLUME_RESPONSE]    = KEY_VOLUME_RESPONSE;
        //Add by guanxiubiao for KYQAZEN-273 add volume key function menu 20161010 end
        //XCSW2 GuoYanjie add for GridLines start
        KEYS_FOR_SETTING[ROW_SETTING_CAMERA_GRID_LINES]    = KEY_CAMERA_GRID_LINES;
        //XCSW2 GuoYanjie add for GridLines end
        //XCSW2 GuoYanjie add for ProfessionalManager start
        KEYS_FOR_SETTING[ROW_SETTING_CAMERA_MANUAL_FOCUS]    = KEY_CAMERA_MANUAL_FOCUS;
        KEYS_FOR_SETTING[ROW_SETTING_CAMERA_MANUAL_SHUTTER]    = KEY_CAMERA_MANUAL_SHUTTER;
        //XCSW2 GuoYanjie add for ProfessionalManager end
        //Add by liyafeng 20170225 start
        KEYS_FOR_SETTING[ROW_SETTING_WHITE_LCD] = KEY_WHITE_LCD;
        //Add by liyafeng 20170225 end
        //xcsw2 liyafeng 20170323 add timestamp item begin
        KEYS_FOR_SETTING[ROW_SETTING_TIMESTAMP] = KEY_CAMERA_TIMESTAMP;
        //xcsw2 liyafeng 20170323 add timestamp item end
        //xcsw2 liyafeng 20170405 add storage location item begin
        KEYS_FOR_SETTING[ROW_SETTING_STORAGE_LOCATION] = KEY_CAMERA_STORAGE_LOCATION;
        //xcsw2 liyafeng 20170405 add storage location item end
    };
    ...
    public static final int[] SETTING_GROUP_COMMON_FOR_TAB = new int[]{
        ...
        ROW_SETTING_CAMERA_SHUTTER_SOUND,//xcsw2 huanglijun 20161123 add shutter sound item
        ROW_SETTING_CAMERA_GRID_LINES,  //XCSW2 GuoYanjie add for GridLines
        ROW_SETTING_WHITE_LCD,//xcsw2 liyafeng 20170225 add for white lcd item
        ROW_SETTING_STORAGE_LOCATION,//xcsw2 liyafeng 20170405 add storage location item
    };
    ...
    public static final int[] SETTING_GROUP_CAMERA_FOR_TAB = new int[]{
        ...
        //XCSW2 GuoYanjie add for ProfessionalManager start
        ROW_SETTING_VOLUME_RESPONSE,//Add by guanxiubiao for KYQAZEN-273 add volume key function menu 20161010
        ROW_SETTING_CAMERA_MANUAL_FOCUS,
        ROW_SETTING_CAMERA_MANUAL_SHUTTER,//camera
        //XCSW2 GuoYanjie add for ProfessionalManager end
        //xcsw2 liyafeng 20170323 add timestamp item begin
        ROW_SETTING_TIMESTAMP,
        //xcsw2 liyafeng 20170323 add timestamp item end
    };
    ...
    //Add by liyafeng 20170225 start
    public static final int[] UN_SUPPORT_BY_BACK_CAMERA = new int[] {
        ROW_SETTING_WHITE_LCD,
    };
    //Add by liyafeng 20170225 end

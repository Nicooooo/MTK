...
public interface ICameraAppUi {
    ...
    public enum CommonUiType {
        ...
        ZOOM,
        SETTING,
        PROFESSIONAL,   //XCSW2 GuoYanjie add for ProfessionalManager
        FACE_BEAUTY_ENTRY,
        CUSTOM,         //XCSW2 GuoYanjie add for CustomOpenNewCamera
    }
    ...
    public enum ViewState {
        ...
        VIEW_STATE_SETTING,
        VIEW_STATE_PROFESSIONAL,    //XCSW2 GuoYanjie add for ProfessionalManager
    ...
    /**
     * Collapse sub setting.
     * @param force If it is true, force to collapse.
     * @return True if it collapse successfully.
     */

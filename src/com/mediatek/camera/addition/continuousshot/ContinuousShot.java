...
public class ContinuousShot extends CameraAddition implements ContinuousShotListener {
    ...
    public ContinuousShot(ICameraContext context) {
        ...
        Log.d(TAG, "[ContinuousShot]the orientation is " + orientation);
    ...
    public void onConinuousShotDone(int capNum) {
        ...
        Log.d(TAG, "[onContinuousShotCallback]");
    }
    ...
    private void startContinuousShot() {
        ...
        if (mICameraContext.getFeatureConfig().isLowRamOptSupport()) {
            ...
            //modify by liyafeng for KELWLPL-458 20161212 (start)
            ...
            //modify by liyafeng for KELWLPL-458 20161212 (end)
        }
        if (isDngOpened()) {
        ...
        Log.d(TAG, "[startContinuousShot]mMaxCaptureNum = " + mMaxCaptureNum);
    }
    ...
    private void clearMemoryLimit() {
        ...
        Log.d(TAG, "[clearMemoryLimit]Consume:" + duration);
    }

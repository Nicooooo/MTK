...
public class PreviewFrameLayout extends RelativeLayout {
    ...
    private View mGrid; //XCSW2 GuoYanjie add for GridLines
    ...
    protected void onFinishInflate() {
        ...
        mGrid = findViewById(R.id.grid_lines);  //XCSW2 GuoYanjie add for GridLines
    }
    ...
    public void showGrid(boolean enabled) {
        mGrid.setVisibility(enabled ? View.VISIBLE : View.INVISIBLE);
    }

...
public class AndroidCamera implements ICamera {
    ...
    /**
     * add raw image callback buffer.
     * @param callbackBuffer the buffer set to jni.
     */
    ...
    public void disableShutterSound() {
        ...
        /*if(ProjectConfig.FEATURE_DISABLE_CAMERA_SOUND_SUPPORT){
            Log.i(TAG, "[disableShutterSound]");

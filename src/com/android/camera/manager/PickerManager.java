...
public class PickerManager extends ViewManager implements Listener,
    ...
    public interface PickerListener {
        ...
        boolean onWhiteLcdPicked(String mode);
    ...
    //Add by liyafeng 20170225 start
    private PickerButton mWhiteLcdPicker;
    //Add by liyafeng 20170225 end
    ...
    //Add by liyafeng 20170225 start
    private static final int BUTTON_WHITE_LCD = 5;
    //Add by liyafeng 20170225 end
    private PickerButton[] mPickerButtons = new PickerButton[PICKER_BUTTON_NUM];

    private static final int MAX_NUM_OF_SHOWEN = 4;
    //Add by liyafeng 20170225 start
    private int[] mButtonPriority = { BUTTON_SLOW_MOTION, BUTTON_HDR, BUTTON_FLASH, BUTTON_WHITE_LCD, BUTTON_CAMERA,
            BUTTON_STEREO };
    ...
    static {
        ...
        //Add by liyafeng 20170225 start
        sShownStatusRecorder[BUTTON_WHITE_LCD] = false;
        //Add by liyafeng 20170225 end
    ...
    protected View getView() {
        ...
        //Add by liyafeng 20170225 start
        mWhiteLcdPicker = (PickerButton) view.findViewById(R.id.onscreen_white_lcd_picker);
        //Add by liyafeng 20170225 end
        ...
        //Add by liyafeng 20170225 start
        mPickerButtons[BUTTON_WHITE_LCD] = mWhiteLcdPicker;
        //Add by liyafeng 20170225 end
        ...
        if (!mDefineOrder) {
            ...
            for (int i = 0; i < mButtonPriority.length; i++) {
                ...
                case BUTTON_FLASH:
                    ...
                    break;
                //Add by liyafeng 20170225 start
                case BUTTON_WHITE_LCD:
                    pref = (IconListPreference) getContext().getListPreference(
                            SettingConstants.ROW_SETTING_WHITE_LCD);
                    break;
                //Add by liyafeng 20170225 end
                case BUTTON_CAMERA:
                    pref = (IconListPreference) getContext().getListPreference(
    ...
    public boolean onPicked(PickerButton button, ListPreference pref, String newValue) {
        ...
        if (mListener != null) {
            ...
            //Add by liyafeng 20170225 start
            case BUTTON_WHITE_LCD:
                picked = mListener.onWhiteLcdPicked(newValue);
                break;
            //Add by liyafeng 20170225 end
            case BUTTON_CAMERA:
    ...
    public void onRefresh() {
        ...
        mFlashPicker.initialize((IconListPreference) getContext().getListPreference(
                SettingConstants.ROW_SETTING_FLASH));
        //Add by liyafeng 20170225 start
        mWhiteLcdPicker.initialize((IconListPreference) getContext().getListPreference(
                SettingConstants.ROW_SETTING_WHITE_LCD));
        //Add by liyafeng 20170225 end

...
public class ModePicker extends ViewManager implements View.OnClickListener,
    ...
    public void onRefresh() {
        ...
        //XCSW2 GuoYanjie modify for LocationOfFaceBeautyIcon start
        int supportModes = -1;
        if(ProjectConfig.FEATURE_DEFAULT_OPEN_FRONT_CAMERA){
            supportModes = ModeChecker.modesShowInPicker(getContext(), getContext().getCameraId()) + 1;
        }else{
            supportModes = ModeChecker.modesShowInPicker(getContext(), 0);
        }
        //XCSW2 GuoYanjie modify for LocationOfFaceBeautyIcon end

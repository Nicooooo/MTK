...
public class ParametersHelper {
    ...
    private static final String KEY_VS_DOF_LEVEL_SUPPORTED = "stereo-supported-dof-level";
    private static final String KEY_VS_DOF_LEVEL_RESULT = "stereo-result-dof-level";
    ...
    public static boolean isFaceBeautySupported(Parameters parameters) {
        return FeatureSwitcher.isCfbEnable()
                && isSupporteFBProperties(parameters, FACEBEAUTY_SMOOTH);
    }
     ...
     * @param level for set.
     */
    public static void setVsDofLevel(Parameters parameters, String level) {
        Log.i(TAG, "setVsDofLevel:" + level);
        if (level != null) {
     ...
     * Set Vs dof mode.
     * @param parameters for check.
     * @param isVsDof whether vs mode.
     */
    public static void setVsDofMode(Parameters parameters, boolean isVsDof) {
        Log.i(TAG, "setVsDofMode:" + isVsDof);
        parameters.set(KEY_VSDOF_MODE, isVsDof ? "on" : "off");
    }
    /**

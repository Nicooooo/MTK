...
//add by liyafeng for KYJWLZEN-18 20170323 (start)
import android.graphics.Bitmap;
...
//add by liyafeng for KYJWLZEN-18 20170323 (end)
...
public class FileSaver {
    ...
    private class PhotoOperator extends RequestOperator {
        ...
        public synchronized void saveRequest() {
            ...
            if (ProjectConfig.XC_FEATURE_CAMERA_TIMESTAMP) {
                String timestamp = ((CameraActivity)mContext).getISettingCtrl().getSettingValue(SettingConstants.KEY_CAMERA_TIMESTAMP);
    ...
    public Bitmap createBitmap(Bitmap src, long dateTaken) {
        ...
        canvas.drawText(datetime, 0, h, p);

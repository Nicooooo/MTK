...
public class Storage {
    ...
    //xcsw2 liyafeng 20170405 add storage location item begin
    public static ISettingCtrl mISettingCtrl;

    public static void setSettingCtrl(ISettingCtrl settingCtrl) {
    ...
    public static String getFileDirectory() {
        ...
        if (ProjectConfig.XC_FEATURE_CAMERA_STORAGE_LOCATION) {
            String storage = mISettingCtrl.getSettingValue(SettingConstants.KEY_CAMERA_STORAGE_LOCATION);
            if ("external".equals(storage)) {
                if (StorageManagerEx.getExternalStoragePath().equals("")) {
                    path = "/storage/emulated/0" + FOLDER_PATH;
                } else {
                    path = StorageManagerEx.getExternalStoragePath() + FOLDER_PATH;
                }
            } else if ("internal".equals(storage)) {
                path = "/storage/emulated/0" + FOLDER_PATH;
            }
        }
        //xcsw2 liyafeng 20170405 add storage location item end

...
public class PhotoActor extends CameraActor implements FocusManager.Listener,
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        */
        ...
        case KeyEvent.KEYCODE_VOLUME_DOWN:
            ...
            if(com.xchengtech.ProjectConfig.XC_ADD_VOLUME_FUNCTION_SETTING_MENU_FOR_CAMERA) break;
            //wangleiquan add for volume key capture (start)
            if (com.xchengtech.ProjectConfig.FEATURE_CAMERA_VOLUME_KEY_CAPTURE) {
            ...
            //wangleiquan add for volume key capture (end)
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        ...
        case KeyEvent.KEYCODE_VOLUME_DOWN:
            ...
            if(com.xchengtech.ProjectConfig.XC_ADD_VOLUME_FUNCTION_SETTING_MENU_FOR_CAMERA){
                String volumeMode = mCameraActivity.getISettingCtrl().getSettingValue(SettingConstants.KEY_VOLUME_RESPONSE);
                Log.i(TAG, "onKeyUp  shoot");

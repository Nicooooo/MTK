        ...
        if (mState == STATE_FOCUSING_SNAP_ON_FINISH) {
            ...
            if (focused) {
                ...
                if (!Parameters.FOCUS_MODE_CONTINUOUS_PICTURE.equals(mFocusMode)) {
                    //XCSW2 GuoYanjie add for FocusSoundControl start
                    if(ProjectConfig.FEATURE_CAMERA_DISABLE_FOCUS_SOUND){
                        boolean soundEnable = "on".equals(
                            mPreferences.getString(SettingConstants.KEY_CAMERA_SHUTTER_SOUND,
                            mContext.getResources().getString(R.string.pref_camera_shutter_sound_default)));
                        if(soundEnable){
                    ...
                    //XCSW2 GuoYanjie add for FocusSoundControl end
                }
            } else {
                mState = STATE_FAIL;
            }

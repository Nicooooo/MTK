...
public class CameraManager {
    ...
    private static final int ENABLE_SHUTTER_SOUND = 29;
    private static final int DISABLE_SHUTTER_SOUND = 30;
    ...
    private static String getMsgLabel(int msg) {
        ...
        case DISABLE_SHUTTER_SOUND:
            return "[distableshuttersound]";
        //xcsw2 huanglijun 20161123 add shutter sound item end
        default:
            break;
        }
        ...
        public void handleMessage(final Message msg) {
            ...
            try {
                ...
                case SET_RAW_IMAGE_CALLBACK:
                    ...
                    Log.i(mSubTag, "set raw callback, meta = " + cb.metaCallback + "," +
                            "raw =" + cb.raw16Callback);
    ...
    public class CameraProxy {
        ...
        public void takePictureAsync(final ShutterCallback shutter, final PictureCallback raw,
            ...
            mCameraHandler.post(new Runnable() {
                @Override
                public void run() {
                    Log.i(mSubTag, " takePictureAsync begin, mIsCameraInError:" + mIsCameraInError);
                    if (mCamera != null && !mIsCameraInError) {
        ...
        public void takePicture(final ShutterCallback shutter, final PictureCallback raw,
            ...
            mCameraHandler.post(new Runnable() {
                @Override
                public void run() {
                    Log.i(mSubTag, " takePicture begin, mIsCameraInError:" + mIsCameraInError);
                    if (mCamera != null && !mIsCameraInError) {
                        mCamera.takePicture(shutter, raw, postview, jpeg);
                        mFaceDetectionRunning = false;
                    }
        ...
        public void disableShutterSound() {
            mCameraHandler.sendEmptyMessage(DISABLE_SHUTTER_SOUND);
            waitDone();
        }
        //xcsw2 huanglijun 20161123 add shutter sound item end

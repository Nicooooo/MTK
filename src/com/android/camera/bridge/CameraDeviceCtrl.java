...
public class CameraDeviceCtrl implements SurfaceHolder.Callback {
    ...
    //XCSW2 wucaihong 20170329 KYJWYMBS-93 start
    private boolean openCameraFlag = false;
    //XCSW2 wucaihong 20170329 KYJWYMBS-93 end
    ...
    public void onPause() {
        ...
        if (mSurfaceView != null) {
            //XCSW quanwei modify for KELWLPL-597 start
            //XCSW2 wucaihong 20170329 KYJWYMBS-93 start
            if (openCameraFlag) {
                mSurfaceView.shrink();
            } else {
            ...
            //XCSW2 wucaihong 20170329 KYJWYMBS-93 end
            //XCSW quanwei modify for KELWLPL-597 end
        }
    ...
    public void applyParameters(boolean isNeedRestart) {
        ...
        boolean isRemainingChanged = dngChanged && !(dngLastState.equals(dngCurrentState));
    ...
    private void prepareParameter(boolean needRestart, boolean isPreviewRatioChanged,
        ...
        mCurCameraDevice.setJpegRotation(mOrientation);
        if (!ParametersHelper.isVsDofSupported(mCurCameraDevice.getParameters())) {
            mCurCameraDevice.setRefocusMode(isStereoMode);
        } else {
            ParametersHelper.setVsDofMode(mCurCameraDevice.getParameters(), isStereoMode);
        }
    ...
    private class CameraStartUpThread extends Thread {
        ...
        private int openCamera(boolean isDualCamera) {
            ...
            if (mCameraDevice != null && mParameters != null) {
                ...
                openCameraFlag = true;
                //XCSW2 wucaihong 20170329 KYJWYMBS-93 end
                //XCSW2 GuoYanjie modify for CameraZSDDefaultOn start
                if(ProjectConfig.FEATURE_CAMERA_ZSD_DEFAULT_ON){
                    defaultZsdValue = mCameraActivity.getResources().getString(R.string.pref_camera_zsd_default);
                }
                //XCSW2 GuoYanjie modify for CameraZSDDefaultOn end

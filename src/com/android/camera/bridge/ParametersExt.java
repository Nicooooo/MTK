    ...
    public String getAntibanding() {
        ...
        if (mCameraDevice != null) {
            ...
            try {
                ...
                //wucaihong Camera Anti-flicker, Default: Auto start
                if(ProjectConfig.FEATURE_CAMERA_ANTI_FLICKER_AUTO_DEFAULT){
                    value = ANTIBANDING_AUTO;
                }else{
                    value = mParameters.getAntibanding();
                }
                //wucaihong Camera Anti-flicker, Default: Auto end
                if (lockedParameters) {
                    mCameraDevice.unlockParameters();
                }
            }

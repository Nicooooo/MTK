...
import com.android.camera.manager.CustomManager;
...
import com.android.camera.manager.ProfessionalManager;
...
//XCSW zhangtao add for take picture use fingerprint 20170113 (start)
...
//XCSW zhangtao add for take picture use fingerprint 20170113 (end)
...
public class CameraAppUiImpl implements ICameraAppUi {
    ...
    private CustomManager mCustomManager;               //XCSW2 GuoYanjie add for CustomOpenNewCamera
    private SettingManager mSettingManager;
    private ProfessionalManager mProfessionalManager;   //XCSW2 GuoYanjie add for ProfessionalManager
    ...
    public void createCommonView() {
        ...
        mCustomManager = new CustomManager(mCameraActivity);                //XCSW2 GuoYanjie add for CustomOpenNewCamera
        mSettingManager = new SettingManager(mCameraActivity);
        mProfessionalManager = new ProfessionalManager(mCameraActivity);    //XCSW2 GuoYanjie add for ProfessionalManager
    ...
    public void initializeCommonView() {
        ...
        mCameraViewArray.put(CommonUiType.CUSTOM, new CameraViewImpl(mCustomManager));              //XCSW2 GuoYanjie add for CustomOpenNewCamera
        mCameraViewArray.put(CommonUiType.SETTING, new CameraViewImpl(mSettingManager));
        mCameraViewArray.put(CommonUiType.PROFESSIONAL, new CameraViewImpl(mProfessionalManager));  //XCSW2 GuoYanjie add for ProfessionalManager
    ...
    //Add by guanxiubiao for KYQAZEN-273 add volume key function menu 20161010 start
    @Override
    public ZoomManager getZoomManager(){
        return mZoomManager;
    }
    //Add by guanxiubiao for KYQAZEN-273 add volume key function menu 20161010 end
    @Override
    ...
    public void setSettingCtrl(ISettingCtrl settingCtrl) {
        ...
        mProfessionalManager.setSettingController(settingCtrl); //XCSW2 GuoYanjie add for ProfessionalManager
    ...
    public boolean collapseSetting(boolean force) {
        //XCSW2 GuoYanjie modify for ProfessionalManager start
        if(mProfessionalManager.isShowProContainer()){
            return mProfessionalManager.collapse(force);
        }else{
            return mSettingManager.collapse(force);
        }
        //XCSW2 GuoYanjie modify for ProfessionalManager end
    }
    ...
    public void setSettingListener(SettingListener listener) {
        ...
        mProfessionalManager.setListener(listener); //XCSW2 GuoYanjie add for ProfessionalManager
    }
    ...
    public void hideAllViews() {
        ...
        mCustomManager.hide();          //XCSW2 GuoYanjie add for CustomOpenNewCamera
        mProfessionalManager.hide();    //XCSW2 GuoYanjie add for ProfessionalManager
    ...
    public void showAllViews() {
        ...
        mCustomManager.show();          //XCSW2 GuoYanjie add for CustomOpenNewCamera
        mProfessionalManager.show();    //XCSW2 GuoYanjie add for ProfessionalManager
    ...
    public void setViewState(ViewState state) {
        ...
        //XCSW2 GuoYanjie add for ProfessionalManager start
        } else if (mProfessionalManager.isShowProContainer()) {
            state = ViewState.VIEW_STATE_PROFESSIONAL;
        //XCSW2 GuoYanjie add for ProfessionalManager end
        ...
        case VIEW_STATE_NORMAL:
            ...
            //XCSW2 GuoYanjie add for CustomOpenNewCamera start
            mCustomManager.setFileter(true);
            mCustomManager.setAnimationEnabled(true, true);
            //XCSW2 GuoYanjie add for CustomOpenNewCamera end
            //XCSW2 GuoYanjie add for ProfessionalManager start
            mProfessionalManager.setFileter(true);
            mProfessionalManager.setAnimationEnabled(true, true);
            //XCSW2 GuoYanjie add for ProfessionalManager end
            // For tablet
            if (FeatureSwitcher.isSubSettingEnabled()) {
        ...
        case VIEW_STATE_CAPTURE:
            ...
            mProfessionalManager.collapse(true);    //XCSW2 GuoYanjie add for ProfessionalManager
            // For tablet
            if (FeatureSwitcher.isSubSettingEnabled()) {
        ...
        case VIEW_STATE_PRE_RECORDING:
            ...
            mCustomManager.setEnabled(false);       //XCSW2 GuoYanjie add for CustomOpenNewCamera
            mProfessionalManager.setEnabled(false); //XCSW2 GuoYanjie add for ProfessionalManager
        ...
        case VIEW_STATE_PROFESSIONAL:
            ...
            setViewManagerEnable(false);
            mSettingManager.setEnabled(false);
            mProfessionalManager.setEnabled(true);
            mIndicatorManager.refresh();
            //when is show setting ,need hide the FaceBeauty view
            if (mFaceBeautyEntryView != null) {
                mFaceBeautyEntryView.hide();
        ...
        //XCSW zhangtao add for take picture use fingerprint 20170113 (start)
        if (ProjectConfig.FEATURE_FINGERPRINT_TAKE_PICTURE) {
            if (isTakePictureUseFingprintEnabled()) {
                if ((state == ViewState.VIEW_STATE_CAMERA_OPENED)) {
                    startFingerprintListener();
                } else if (state == ViewState.VIEW_STATE_CAMERA_CLOSED) {
    ...
    private OnShutterButtonListener mPhotoShutterListener = new OnShutterButtonListener() {
        ...
        public void onShutterButtonLongPressed(ShutterButton button) {
            ...
            if (listener != null) {
                //Add by liyafeng 20170225 start
                addWhiteView();
                //Add by liyafeng 20170225 end
        ...
        public void onShutterButtonFocus(ShutterButton button, boolean pressed) {
            ...
            mSettingManager.collapse(true);
            //XCSW2 GuoYanjie add for ProfessionalManager start
            mProfessionalManager.cancleHideAnimation();
            mProfessionalManager.collapse(true);
            //XCSW2 GuoYanjie add for ProfessionalManager end
            // For tablet
            if (FeatureSwitcher.isSubSettingEnabled()) {
                mSubSettingManager.collapse(true);
    ...
    private void setViewManagerEnable(boolean enabled) {
        if (mCameraActivity.isNonePickIntent()) {
            ...
            mCustomManager.setEnabled(enabled);     //XCSW2 GuoYanjie add for CustomOpenNewCamera
        }
        mSettingManager.setEnabled(enabled);
        mProfessionalManager.setEnabled(enabled);   //XCSW2 GuoYanjie add for ProfessionalManager
    ...
    private boolean isEffectConditionSatisfied() {
        ...
        if (pref != null && pref.isEnabled()
                ...
                && mCurrentViewState != ViewState.VIEW_STATE_PROFESSIONAL   //XCSW2 GuoYanjie add for ProfessionalManager
    ...
    //XCSW zhangtao add for take picture use fingerprint 20170113 (start)
    private boolean isTakePictureUseFingprintEnabled() {
        return Settings.System.getInt(mCameraActivity.getContentResolver(),
                Settings.System.FINGERPRINT_TAKE_PICTURE, 0) != 0;
    }

    private Runnable mStartVerifyFingerprintRunnable = new Runnable() {
        public void run() {
            startFingerprintListener();
        }
    };
    ...
    private void startFingerprintListener() {
        Log.d(TAG, "startFingerprintListener");
        if (mFingerprintManager == null) {
            mFingerprintManager = mCameraActivity.getSystemService(FingerprintManager.class);
        }
        if (!mFingerprintManager.isHardwareDetected()) {
            Log.d(TAG, "not support fingerprint!");
            return;
        }
    ...
    private void stopFingerprintListener() {
        Log.d(TAG, "stopFingerprintListener");
        if (mFingerprintCancel != null && !mFingerprintCancel.isCanceled()) {
            mFingerprintCancel.cancel();
        }
        mFingerprintCancel = null;
        mHandler.removeCallbacks(mStartVerifyFingerprintRunnable);
    }
    ...
    private AuthenticationCallback mAuthCallback = new AuthenticationCallback() {
        ...
        public void onAuthenticationError(int errMsgId, CharSequence errString) {
            Log.d(TAG, "onAuthenticationError.errString:" + errString);
        }
    ...
    private void takePictureUseFingerprint() {
        getPhotoShutter().performClick();
        mHandler.post(mStartVerifyFingerprintRunnable);
    }
    //XCSW zhangtao add for take picture use fingerprint 20170113 (end)
    ...
    public void addWhiteView() {
        mCameraActivity.addWhiteView();
    }

    @Override
    public void removeWhiteView() {
        mCameraActivity.removeWhiteView();
    }
    //Add by liyafeng 20170225 end
}
